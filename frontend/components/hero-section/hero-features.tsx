                            ...
                            <CardContent className="pt-6">
                                ...
                                <div className="relative z-10 mt-6 space-y-2 text-center">
                                    ...
                                    <p className="text-foreground">
                                        Solve problems in Python, Java, and C++.
                                        Practice competitive programming with
                                        your preferred language using our Monaco
                                        Editor.
                                    </p>
                                </div>
                            </CardContent>
                        ...
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
                            <CardContent className="pt-6">
                                ...
                                <div className="relative z-10 mt-6 space-y-2 text-center">
                                    ...
                                    <p className="text-foreground">
                                        Challenge friends in real-time coding
                                        battles. Test your algorithmic skills
                                        head-to-head in competitive duels.
                                    </p>
                                </div>
                            </CardContent>
                        </Card>
                                ...
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-foreground">
                                            ...
                                            Climb the leaderboard, earn rating
                                            points, and showcase your
                                ...
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-foreground">
                                            ...
                                            levels, master data structures and
                                            algorithms through practice.
                                        </p>
                                    </div>
                                </div>
