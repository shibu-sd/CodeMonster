            ...
            <div className="mx-auto max-w-5xl px-6">
                <div className="text-center mb-12">
                    ...
                    <p className="mt-4">
                        ...
                        coding skills with real-time battles and comprehensive
                        problem sets.
                    </p>
                </div>
                <div className="relative">
                    ...
                    >
                        ...
                        >
                            <Card className="relative h-full flex overflow-hidden transition-all duration-300 ease-out hover:scale-105 hover:shadow-xl hover:shadow-primary/10 hover:-translate-y-1">
                        ...
                        >
                            <Card className="relative h-full overflow-hidden transition-all duration-300 ease-out hover:scale-105 hover:shadow-xl hover:shadow-primary/10 hover:-translate-y-1">
                                <CardContent className="pt-6">
                                    ...
                                    <div className="relative z-10 mt-6 space-y-2 text-center">
                                        ...
                                        <p className="text-foreground">
                                            Solve problems in Python, Java, and
                                            C++. Practice competitive
                                            programming with your preferred
                                            language using our Monaco Editor.
                                        </p>
                                    </div>
                                </CardContent>
                            </Card>
                                ...
                                <CardContent className="pt-6">
                                    ...
                                    <div className="relative z-10 mt-6 space-y-2 text-center">
                                        ...
                                        <p className="text-foreground">
                                            ...
                                            coding battles. Test your
                                            algorithmic skills head-to-head in
                                            competitive duels.
                                        </p>
                                    </div>
                                </CardContent>
                        ...
                        >
                            <Card className="card variant-outlined relative h-full overflow-hidden transition-all duration-300 ease-out hover:scale-105 hover:shadow-xl hover:shadow-primary/10 hover:-translate-y-1">
                                    ...
                                    <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <p className="text-foreground">
                                                ...
                                                worldwide. Climb the
                                                leaderboard, earn rating points,
                                                and showcase your
                                ...
                                <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                                    <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <p className="text-foreground">
                                                Improve your algorithmic
                                                thinking skills. From beginner
                                                to advanced levels, master data
