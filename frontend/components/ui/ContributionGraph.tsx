...
const CONTRIBUTION_COLORS = [
    "bg-gray-200 dark:bg-gray-800", // Level 0 - No contributions
    "bg-green-200 dark:bg-green-900", // Level 1
    "bg-green-300 dark:bg-green-800", // Level 2
    "bg-green-400 dark:bg-green-700", // Level 3
    "bg-green-500 dark:bg-green-600", // Level 4 - Max
];
        ...
        <div className={`contribution-graph ${className}`}>
            ...
            {showTooltips && hoveredDay && (
                <motion.div
                    ...
                    className="bg-gray-800 text-white pointer-events-none fixed z-50 rounded-lg border border-gray-600 px-3 py-2 text-sm shadow-lg"
                    style={{
                ...
                >
                    <div>
                        {getContributionText(hoveredDay.count)} on{" "}
